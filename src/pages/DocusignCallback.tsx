...
export const DocusignCallback: FC = () => {
  ...
  if (status === "success") {
    return (
      <BrandedShell
        ...
        subtitle="Your MS2GO account is now linked. You can close this window and return to the portal."
      >
        ...
        <p className="branded-body">
          Documents and signatures will now flow through your secure MS2GO workspace. No further action is needed.
        </p>
  ...
  return (
    ...
    >
      ...
      <p className="branded-body">
        If this page doesn't update in a few moments, return to the portal and try connecting again.
      </p>
      <div className="branded-actions">
